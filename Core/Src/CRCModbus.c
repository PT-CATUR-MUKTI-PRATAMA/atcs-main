...
/*
 * Function to convert string to uint8_t array
 */
...
/*
 * Function to convert string to uint8_t array and calculate its CRC-16 Modbus
 */
...
//        byteArray[i] = (uint8_t)data[i];
//    }
//
//    uint16_t crc = calculateCRC16(byteArray, dataLength);
//
//    free(byteArray);
//    return crc;
//}
